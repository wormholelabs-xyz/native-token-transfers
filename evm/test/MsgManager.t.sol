...
import "../src/interfaces/IMsgReceiver.sol";
...
contract TestMsgManager is Test {
    ...
    bytes32 refundAddr = toWormholeFormat(address(0x789));
    ...
    function testMsgManagerBasic() public {
        ...
        uint64 s1 = msgManager.sendMessage(chainId2, refundAddr, payload1, transceiverInstructions);
        uint64 s2 = msgManager.sendMessage(chainId2, refundAddr, payload2, transceiverInstructions);
        uint64 s3 = msgManager.sendMessage(chainId2, refundAddr, payload3, transceiverInstructions);
        vm.stopPrank();
    ...
    function testMsgManagerWithThreshold2() public {
        ...
        assertEq(msgManager.sendMessage(chainId2, refundAddr, payload, transceiverInstructions), 0);
