...
// fetch explicit disclosures for before a cross-participant submit.
//
// TODO(phase 5): nothing in cmd/ntt-playground consults this package yet. Wiring it in --
// intersecting a command's needed templates with Config.Disclose before a cross-participant
// submit, fetching payloads via the new Playground/Prepare.daml scripts, and attaching them
// via Playground/Disclose.daml's RemoteSeam -- is phase 5's job (see the plan's §4 and §7
// step 5). This package only needs to compile and parse correctly for phase 1.
package disclosure
