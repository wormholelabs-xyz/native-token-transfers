...
func newInitCmd(a *app) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			a.vlogf(cmd, "init: proposing genesis as operator: CoreStateBootstrapProposal (guardian set idx 0), EmitterRegistry, ReplayRootRegistry, NttManagerRegistry")
			...
			a.vlogf(cmd, "init: accepting genesis as guardianGovernance: creating CoreState")
